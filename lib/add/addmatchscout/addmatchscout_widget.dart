...
import 'addmatchscout_model.dart';
export 'addmatchscout_model.dart';

class AddmatchscoutWidget extends StatefulWidget {
  const AddmatchscoutWidget({
    super.key,
  ...
  @override
  State<AddmatchscoutWidget> createState() => _AddmatchscoutWidgetState();
}

class _AddmatchscoutWidgetState extends State<AddmatchscoutWidget> {
  late AddmatchscoutModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddmatchscoutModel());

    _model.compnumTextController ??= TextEditingController();
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      await CompscoutlistTable().insert({
                                        'teamnumber':
                                            _model.teamnumTextController.text,
                                        'compnum': int.tryParse(
                                            _model.compnumTextController.text),
                                        'comptype': _model.comtypeValue,
                                        'alliancecolor': _model.alliencecolor,
                                        'autoendgamerobotpos':
                                            _model.autoendgameValue,
                                        ...
                                        'autosamplenet': _model.autonetValue,
                                        'teleopsamplenet':
                                            _model.teleopnetValue,
                                        'autohighchemberspec':
                                        ...
                                        'teleoptotal': valueOrDefault<int>(
                                          functions.calteleoptotal(
                                              _model.teleophighbasketValue!,
                                              _model.teleoplowbasketValue!,
                                              _model.teleopnetValue!,
