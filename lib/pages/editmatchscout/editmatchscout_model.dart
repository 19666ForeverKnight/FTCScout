...
import 'editmatchscout_widget.dart' show EditmatchscoutWidget;
import 'package:flutter/material.dart';

class EditmatchscoutModel extends FlutterFlowModel<EditmatchscoutWidget> {
  ...
  FocusNode? compnumFocusNode;
  TextEditingController? compnumTextController;
  String? Function(BuildContext, String?)? compnumTextControllerValidator;
  ...
  // State field(s) for comtype widget.
  String? comtypeValue;
  FormFieldController<String>? comtypeValueController;
  ...
  @override
  void dispose() {
    compnumFocusNode?.dispose();
    compnumTextController?.dispose();
